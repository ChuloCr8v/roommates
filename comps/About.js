...
const About = () => {
  return(
    <div className="About my-20 px-2 md:px-16 flex flex-col items-center justify-center ">
      <h1 className="text-2xl text-center text-red-600 font-black">Need a rooMMate?</h1>
      ...
      <h1 className="text-2xl mt-20 text-center text-red-600 font-black">Need a Room?</h1>
      <p className="text-center mt-5"> 
      ...
      <button 
      className="bg-red-600 text-white text-sm rounded-2xl py-2 px-3 mt-8 uppercase transition all duration-1500 transform hover:scale-105 hover:opacity-60" 
      >
